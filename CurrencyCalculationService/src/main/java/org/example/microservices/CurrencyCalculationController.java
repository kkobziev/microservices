...
public class CurrencyCalculationController {
    ...
    public CurrencyCalculationResponse convertCurrency(@PathVariable String from,
        ...
        ResponseEntity<CurrencyCalculationResponse> responseEntity = new RestTemplate().getForEntity("http://127.0.0.1:8000/currency-exchange/from/{from}/to/{to}",
                CurrencyCalculationResponse.class, uriVariables);
        CurrencyCalculationResponse response = responseEntity.getBody();
